...
foreach v of varlist protest_count-intense_massviolence {
	...
	graph export "results/GDELTProtestEventStudies/`v'.png", replace
}
...
graph export "results/GDELTProtestEventStudies/raw_counts.png", replace
estimates clear
...
graph export "results/GDELTProtestEventStudies/logs.png", replace
estimates clear
...
graph export "results/GDELTProtestEventStudies/indicators.png", replace
estimates clear
...
graph export "results/GDELTProtestEventStudies/thresholds.png", replace
estimates clear
